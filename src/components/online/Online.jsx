...
import { onlineOverview, onlineTimeline } from '../../constants';
...
const Online = () => {
  ...
  return (
    <div id="#Online" className='online-container '>
      <div className='online-wrapper'>

        <div className="container-o1">
          <div className="wrapper-o1">
            <h1 className='ss:text-[50px] text-[35px] p-3 text-center'>Learn the  <span ref={textref} className='text-gradient-o ityped'> </span>  Stock Market (online)</h1>
          </div>
        </div>
